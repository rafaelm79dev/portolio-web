    ...
    const experiences = [
        {
            ...
            description: language === "en" ? "⁃\tDesigned and built data dashboards in Power BI, connected to SQL Server, MySQL, web services, and Excel. This reduced the time needed to create reports and helped managers make better decisions.\n⁃\tBuilt SharePoint solutions (2013–Online), including intranet portals and public websites, to make information easier to find and use.\n⁃\tGave consulting services to different clients, making sure their solutions matched their business goals and improved efficiency.\n⁃\tManaged data migration projects in SharePoint, connecting with other platforms and databases while keeping the data accurate.\n⁃\tSupported data warehouses and relational databases. Designed and built ETL processes to make systems faster and more reliable." :
        ...
        },
        {
            ...
            description: language === "en" ? "⁃\tBuild reports and dashboards in Power BI so managers can see key business numbers in real time and make faster decisions.\n⁃\tConnect and combine data from different sources, like SQL Server and SharePoint, into one reliable view.\n⁃\tModel data and create DAX measures for deeper analysis, beyond standard reports." :
        ...
        },
        {
            ...
            description: language === "en" ? "⁃\tBuild Power BI solutions so leadership can see business performance clearly and make faster decisions.\n⁃\tSupport Project Server (PWA) for more reliable project tracking.\n⁃\tSupport on-premises SharePoint portals, keeping important internal systems running well.\n⁃\tAutomate processes with Power Automate and build apps with Power Apps, replacing manual work with faster processes." :
        ...
        },
        {
            ...
            description: language === "en" ? "⁃\tLed the migration of SharePoint from on-premise to Online without stopping daily operations.\n⁃\tAutomated business processes with Power Automate, reducing manual and repetitive work.\n⁃\tBuilt internal management apps with Power Apps and Power Automate, replacing manual tracking of internal projects." :
        ...
        },
        {
            ...
            description: language === "en" ? "⁃\tDeveloped APIs in .NET using C#, helping the product grow and stay stable.\n⁃\tMaintained and improved Data Warehouses in SQL Server, making it easier to access important data for reports and decisions.\n⁃\tBuilt SQL Server solutions with stored procedures, functions, and views, to automate processes and reduce errors.\n⁃\tDesigned ETL processes with SQL Server Integration Services (SSIS) for faster, more reliable data integration, and published them with Azure Data Factory.\n⁃\tCreated business reports with SQL Server Reporting Services (SSRS) and Power BI to support key performance analysis." :
        ...
        },
        {
            ...
            description: language === "en" ? "⁃\tWorked as technical lead on several projects in different areas and technologies, including BI implementations and SharePoint solutions.\n⁃\tParticipated in the full lifecycle of software projects, making sure solutions were scalable and met business needs." :
    ...
    const projects = [
        {
            ...
            description: language === "en" ? "Internal web app (personal project) to manage a monthly employee purchase benefit, with a spending limit, approval control, and full traceability. Built with Blazor Server (.NET 10), using Microsoft Graph API and SharePoint Lists as the backend, with custom authentication, a full admin panel, and an audit system. Built with the help of Claude AI." :
        ...
        },
        {
            ...
            description: language === "en" ? "I love playing Padel, so I'm building a solution with AI that lets me record and analyze game statistics. The goal is to help players see their progress, find patterns in their performance, and make better decisions to improve their technique and strategy." :
        ...
        <div className="flex flex-col max-w-screen-md mx-auto">
            ...
            <section id="profile" className="px-4 md:px-6">
                <div className="container mx-auto py-8 md:py-3">
                    ...
                    <p className="text-xs md:text-sm text-foreground/60 mt-3">
                        {t("profile.languages")}
                    </p>
                </div>
            </section>
